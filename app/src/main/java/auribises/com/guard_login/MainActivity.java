package auribises.com.guard_login;
...
public class MainActivity extends AppCompatActivity {
    ...
    boolean  validation(){
        ...
        if(login.getUsername().isEmpty()){
            flag = false;
            editTextname.setError("Please Enter correct Username");
        }else{
            if(!(login.getUsername().contains("admin") && login.getPassword().contains("admin"))){
                flag = false;
                editTextpass.setError("Please Enter correct Password");
            }
        }
        return flag;
    }
